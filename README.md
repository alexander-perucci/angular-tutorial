...
7. **Download and import the first example**
   ...
   * do **NOT** select the *Select archive* file 
...
8. **Run**
   ...
   *Run As → ng test*
   ...
   Chrome should open and display that test cases failed. 
   The failing test cases are intended.
...
9. **Download Slides**
   ...
   You can download  the most current version after the tutorial.
